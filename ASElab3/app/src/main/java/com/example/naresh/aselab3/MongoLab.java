...
public class MongoLab  {
    ...
    public void Post(String fname,String lname,String email, String password,int check) {
        post p=new post(fname,lname,email,password,check);
        p.execute("");
    ...
    class post extends AsyncTask<String, String,String> {
        ...
        String password;
        String flocation,tlocation,date,time;
        int check;
        ...
        post(String flocation,String tlocation,String date, String time,int check){
            if(check==1) {
